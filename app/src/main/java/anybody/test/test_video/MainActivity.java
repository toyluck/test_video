package anybody.test.test_video;
...
import anybody.test.test_video.auth.AuthTest;
import anybody.test.test_video.common.Contant;
import anybody.test.test_video.common.RequestCode;
import anybody.test.test_video.result.RecordResult;
import anybody.test.test_video.utils.AppConfig;
import anybody.test.test_video.utils.AppGlobalSetting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_auth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AuthTest.getInstance().initAuth(v.getContext(), Contant.APP_KEY, Contant.APP_SECRET, Contant.space);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    FileUtils.copyFiles(new File(videoFile), MainActivity.this);
                }
            }).start();
    ...
    private void startUpload() {
        ...
        uploadService.setQupaiUploadListener(new QupaiUploadListener() {
            ...
            public void onUploadComplte(String uuid, int responseCode, String responseMessage) {
                ...
                imageUrl = Contant.domain + "/v/" + responseMessage + ".jpg" + "?token=" + Contant.accessToken;
